...
# Introdução
- Fale sobre o seu projeto e o que usou para desenvolver ele.</br>
...
- Explique o que é necessário para permitir que ele funcione corretamente no Device ao qual a pessoal ira abrir.</br>
...
# Screenshots e uso
- Prints, Gifs e vídeos são super recomendados aqui. Falar sobre o funcionamento dele também.</br>
